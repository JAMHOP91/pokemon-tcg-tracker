"""
PlayX - Pokemon TCG Pre-Orders. Shopify store, uses products.json.
They sell multiple TCGs (MTG, One Piece, Riftbound, etc.) in the same
pre-order collection, so this explicitly requires "pokemon" in the title.
"""
