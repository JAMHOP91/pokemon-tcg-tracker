"""
Magic Red Dragon - Pokemon TCG Pre-Orders. Shopify store, uses
products.json. They sell multiple TCGs (MTG, One Piece, Sorcery) in
the same pre-orders collection, so this explicitly requires "pokemon"
in the title.
"""
...
BASE_URL = "https://magicreddragon.co.nz"
