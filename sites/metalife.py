"""
MetaLife - Pokemon TCG. Shopify store, uses products.json. This is a
large general hobby/collectibles store (Gundam, figures, other TCGs),
so this is scoped to their populated Pokemon collection plus an
explicit "pokemon" title check as a safety net.
"""
