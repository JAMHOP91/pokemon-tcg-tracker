"""
TCG Collector NZ - Pre-Orders. Shopify store, uses products.json.
Their dedicated pre-order collection mixes many TCGs (Digimon, MTG,
Star Wars, Riftbound, CardFight Vanguard), so this explicitly requires
"pokemon" in the title.
"""

import requests
from sites.filters import is_tcg_product

SITE_NAME = "TCG Collector NZ - Pre-Orders"
BASE_URL = "https://tcgcollectornz.com"
COLLECTION_HANDLE = "pre-order-products-tcg-collector-nz"
