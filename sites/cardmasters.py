"""
Card Masters NZ - Pokemon TCG. Shopify store, uses products.json.
Their "pokemon" collection is sealed product only (singles live in a
separate collection), and only includes products with a variant in stock.
"""
